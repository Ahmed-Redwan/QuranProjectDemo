    ...
    public class Recycler_show_student extends RecyclerView.Adapter<Recycler_show_student.View_holder> {


        ArrayList<Student_Info> student_imageand_names;


        public Recycler_show_student(ArrayList<Student_Info> student_imageand_names) {
        ...
        public void onBindViewHolder(@NonNull final View_holder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent i = new Intent(view.getContext(), MassegeActivity.class);
